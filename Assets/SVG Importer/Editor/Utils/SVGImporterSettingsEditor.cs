...
namespace SVGImporter {
    ...
    public class SVGImporterSettingsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(optimizeMesh, new GUIContent("Optimize Mesh"));
            ...
            EditorGUILayout.PropertyField(generateNormals, new GUIContent("Generate Normals"));
            EditorGUILayout.PropertyField(generateTangents, new GUIContent("Generate Tangents"));
            GUILayout.Space(10f);
